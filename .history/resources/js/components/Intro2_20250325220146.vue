...
.video-mask {
  ...
  clip-path: polygon(
    ...
    30% 20%, 40% 20%, 40% 80%, 30% 80%, /* Ô chữ nhật đầu tiên */
    60% 20%, 70% 20%, 70% 80%, 60% 80%  /* Ô chữ nhật thứ hai */
  );
}
...
@media (max-width: 1024px) {
  ...
  .video-mask {
    clip-path: polygon(
      0% 0%, 100% 0%, 100% 100%, 0% 100%, /* Nền chính */
      40% 25%, 50% 25%, 50% 75%, 40% 75%, /* Ô chữ nhật đầu tiên */
      55% 25%, 65% 25%, 65% 75%, 55% 75%  /* Ô chữ nhật thứ hai */
    );
  }
}
</style>

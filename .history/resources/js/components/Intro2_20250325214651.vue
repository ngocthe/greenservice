<template>
  <div class="container">
    ...
    <div ref="videoSection" class="video-wrapper" :class="{ show: videoVisible }">
      ...
      <div class="mask"></div> <!-- Lớp mask với hai ô chữ nhật -->
    </div>
  </div>
</template>
...
.mask {
  ...
  clip-path: polygon(
    ...
    28% 10%, 38% 10%, 38% 90%, 28% 90%, /* Ô chữ nhật đầu tiên */
    62% 10%, 72% 10%, 72% 90%, 62% 90%  /* Ô chữ nhật thứ hai */
  );
  border-radius: 10px;
}
...
@media (max-width: 768px) {
  ...
  .mask {
    clip-path: polygon(
      0% 0%, 100% 0%, 100% 100%, 0% 100%, /* Nền chính */
      35% 5%, 45% 5%, 45% 95%, 35% 95%, /* Ô chữ nhật đầu tiên */
      55% 5%, 65% 5%, 65% 95%, 55% 95%  /* Ô chữ nhật thứ hai */
    );
  }
}
</style>

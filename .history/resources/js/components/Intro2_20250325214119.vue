<template>
  <div class="container">
    ...
    <!-- Video bên phải với 2 ô chữ nhật dọc -->
    <div class="video-wrapper">
      <video autoplay loop muted playsinline>
        <source src="/images/intro.mp4" type="video/mp4" />
        Trình duyệt không hỗ trợ video.
      </video>
      <div class="mask"></div> <!-- Lớp mask với 2 ô chữ nhật dọc -->
    </div>
  </div>
</template>
...
.mask {
  ...
  width: 100%;
  height: 100%;
  background-color: rgba(34, 139, 34, 0.9); /* Màu nền xanh */
  clip-path: polygon(
    0% 0%, 100% 0%, 100% 100%, 0% 100%, /* Nền chính */
    30% 0%, 40% 0%, 40% 100%, 30% 100%, /* Lỗ chữ nhật thứ nhất */
    60% 0%, 70% 0%, 70% 100%, 60% 100%  /* Lỗ chữ nhật thứ hai */
  );
  border-radius: 10px;
}

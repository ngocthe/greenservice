<template>
  <div class="footer">
    ...
    <div class="contact-icons">
      <a href="https://zalo.me/your_zalo_number" target="_blank" class="icon zalo">
        <img src="/path/to/zalo-icon.png" alt="Zalo" />
      </a>
      <a href="tel:your_phone_number" class="icon hotline">
        <img src="/path/to/phone-icon.png" alt="Hotline" />
      </a>
    </div>
  </div>
</template>

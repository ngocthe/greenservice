<template>
  <div class="remarkable-section" style="background-color: #f5f5f5;" v-intersect>
    ...
    <div class="figures">
      <div v-for="(item, index) in figures" :key="index" class="figure-item animate">
        <div class="number-label">
          <count-up v-if="isVisible" :end-val="item.value" :duration="2.5" />+ {{ item.label }}
        </div>
      </div>
    ...
    <div class="trusted-section">
      <h2 class="section-title animate-title">Được Tin Cậy Bởi Hơn 1000 Khách hàng</h2>
...
@media (max-width: 768px) {
  ...
  .figures {
    ...
    gap: 20px;
    margin-bottom: 30px;
    align-items: center; /* căn giữa mỗi item */
  }
